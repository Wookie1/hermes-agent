...
KANBAN_GUIDANCE = (
    ...
    "\n"
    "For worker+verifier(+synthesizer) patterns call `kanban_swarm` — one "
    "call, dependencies guaranteed (workers parallel → verifier waits for "
    "ALL → synthesizer last). Hand-rolled verifiers MUST list every worker "
    "in `parents=[...]` or they run before the work exists.\n"
    "\n"
